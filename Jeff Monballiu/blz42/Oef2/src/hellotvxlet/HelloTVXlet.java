...
public class HelloTVXlet implements Xlet, UserEventListener, HActionListener {
    ...
    public void initXlet(XletContext context) throws XletStateChangeException {
        ...
        knop4.setFocusTraversal(knop3, knopHulp, null, null);//op, neer, links, rechts
        knopHulp.setFocusTraversal(knop4, knop1, null, null);
    ...
    private void getHelp(){
        ...
        knop3.setFocusTraversal(knopHulp, knop4, null, null);//op, neer, links, rechts
        knop4.setFocusTraversal(knop3, knopHulp, null, null);//op, neer, links, rechts
        knopHulp.setFocusTraversal(knop4, knop3, null, null);//op, neer, links, rechts
